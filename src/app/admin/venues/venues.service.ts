...
export class VenuesService {
  ...
  uploadWorkshop(workshop: Activity): Observable<Venue> {
    return this.http.post<Venue>(`${this.url}/workshop`, workshop, { headers: this.headers });
  }
  ...
  uploadPresentation(presentation: Activity): Observable<Venue> {
    return this.http.post<Venue>(`${this.url}/presentation`, presentation, { headers: this.headers });
  }
